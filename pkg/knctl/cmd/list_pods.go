...
func NewListPodsOptions(ui ui.UI, depsFactory DepsFactory) *ListPodsOptions {
	return &ListPodsOptions{ui: ui, depsFactory: depsFactory}
}
...
func (o *ListPodsOptions) isOKStatus(pod corev1.Pod) bool {
	return pod.Status.Phase == corev1.PodRunning || pod.Status.Phase == corev1.PodSucceeded
}

func (o *ListPodsOptions) podRestarts(pod corev1.Pod) int {
	var count int
...
func (o *ListPodsOptions) setUpPodWatching() (chan corev1.Pod, error) {
