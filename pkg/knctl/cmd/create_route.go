...
func NewCreateRouteOptions(ui ui.UI, depsFactory DepsFactory) *CreateRouteOptions {
	return &CreateRouteOptions{ui: ui, depsFactory: depsFactory}
}

func NewCreateRouteCmd(o *CreateRouteOptions, flagsFactory FlagsFactory) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "create",
...
func (o *CreateRouteOptions) Run() error {
...
func (o *CreateRouteOptions) createOrUpdate(servingClient servingclientset.Interface, route *v1alpha1.Route) error {
...
func (o *CreateRouteOptions) update(servingClient servingclientset.Interface, route *v1alpha1.Route) error {
