...
func NewCreateBuildOptions(
	...
	return &CreateBuildOptions{ui: ui, configFactory: configFactory, depsFactory: depsFactory, cancelSignals: cancelSignals}
}

func NewCreateBuildCmd(o *CreateBuildOptions, flagsFactory FlagsFactory) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "create",
...
func (o *CreateBuildOptions) printTable(b *v1alpha1.Build) {
	table := uitable.Table{
